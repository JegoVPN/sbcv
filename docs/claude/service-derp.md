<!-- Status: implementation-verified. Source: stable + testing docs/configuration/service/derp.md, shared/listen.md, shared/tls.md, shared/dial.md; verified against Palette.tsx, SbcNode.tsx, Inspector.tsx, sharedFieldRegistry.ts, useProjectStore.ts, graph.ts, commands.ts. -->
