<!-- Status: official-read. Sources: stable docs/configuration/dns/server/hosts.md, testing docs/configuration/dns/server/hosts.md, stable docs/configuration/dns/server/index.md, Palette.tsx, SbcNode.tsx, Inspector.tsx, commands.ts, protocols.ts, sharedFieldRegistry.ts, types.ts. -->
