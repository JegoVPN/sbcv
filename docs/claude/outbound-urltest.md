<!-- Generated by deep-review agent. Source: stable + testing docs/configuration/outbound/urltest.md, Inspector.tsx, SbcNode.tsx, sharedFieldRegistry.ts, graph.ts, commands.ts -->
