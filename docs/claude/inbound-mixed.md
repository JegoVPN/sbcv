<!-- Status: official-read. Source: stable inbound/mixed.md + testing diff (identical) + shared/listen.md + Palette/SbcNode/Inspector/protocols grep. UI verification + implementation fixes still pending. -->
