<!-- Status: official-read. Source: stable certificate/index.md + testing diff + Palette/SbcNode/Inspector grep. UI verification + implementation fixes still pending. -->
