<!-- Status: official-read. Source: stable inbound/direct.md + stable shared/listen.md + testing diff + Palette/SbcNode/Inspector/sharedFieldRegistry grep. UI verification + implementation fixes still pending. -->
