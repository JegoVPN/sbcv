# DNS Server Hosts - Codex review cross-map
...
| C1-6 | P1 | DNS Server | Hosts `predefined` and HTTPS/H3 header maps can persist empty keys; diagnostics do not catch empty map keys. | Reject or delay empty map keys in Inspector and diagnostics. |
...
SUMMARY: 1 P0, 5 P1, 0 P2; icons 0 P1, 0 P2.
