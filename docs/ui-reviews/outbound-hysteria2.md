<!-- Status: official-read. Source: stable docs/configuration/outbound/hysteria2.md, shared/dial.md, and shared/tls.md; reviewed against current Palette, SbcNode, and Inspector registries. UI verification and implementation fixes still required. -->
