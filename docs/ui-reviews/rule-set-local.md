<!-- Status: official-read. Source: stable docs/configuration/rule-set/index.md, rule-set/source-format.md, rule-set/headless-rule.md, and rule-set/adguard.md; reviewed against current Palette, SbcNode, and Inspector registries. UI verification and implementation fixes still required. -->
