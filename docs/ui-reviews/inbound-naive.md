<!-- Status: official-read. Source: stable docs/configuration/inbound/naive.md, shared/listen.md, and shared/tls.md; reviewed against current Palette, SbcNode, and Inspector registries. UI verification and implementation fixes still required. -->
