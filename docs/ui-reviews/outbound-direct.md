<!-- Status: official-read. Source: stable docs/configuration/outbound/direct.md and shared/dial.md plus current Palette, SbcNode, and Inspector registries. UI verification and implementation fixes still required. -->
