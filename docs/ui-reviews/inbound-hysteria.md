<!-- Status: official-read. Source: stable docs/configuration/inbound/hysteria.md, shared/listen.md, and shared/tls.md; reviewed against current Palette, SbcNode, and Inspector registries. UI verification and implementation fixes still required. -->
