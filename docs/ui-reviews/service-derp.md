<!-- Status: official-read. Source: stable docs/configuration/service/derp.md plus shared/listen.md, shared/tls.md, and shared/dial.md; reviewed against current Palette, SbcNode, and Inspector registries. UI verification and implementation fixes still required. -->
