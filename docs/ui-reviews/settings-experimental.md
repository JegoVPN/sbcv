<!-- Status: official-read. Source: stable docs/configuration/experimental/index.md, experimental/cache-file.md, experimental/clash-api.md, and experimental/v2ray-api.md; reviewed against current Palette, SbcNode, and Inspector registries. UI verification and implementation fixes still required. -->
