<!-- Status: official-read. Source: stable docs/configuration/dns/server/fakeip.md plus current Palette, SbcNode, and Inspector registries. UI verification and implementation fixes still required. -->
