<!-- Status: official-read. Source: stable docs/configuration/inbound/shadowtls.md, shared/listen.md, and shared/dial.md; reviewed against current Palette, SbcNode, and Inspector registries. UI verification and implementation fixes still required. -->
