<!-- Status: official-read. Source: stable docs/configuration/outbound/shadowsocks.md, shared/dial.md, shared/udp-over-tcp.md, and shared/multiplex.md; reviewed against current Palette, SbcNode, and Inspector registries. UI verification and implementation fixes still required. -->
