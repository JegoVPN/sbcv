<!-- Status: official-read. Source: stable docs/configuration/dns/server/http3.md, shared/tls.md, and shared/dial.md; reviewed against current Palette, SbcNode, and Inspector registries. UI verification and implementation fixes still required. -->
