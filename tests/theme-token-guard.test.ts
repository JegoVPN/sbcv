...
// Ratchet history: pre-T1 = 391 → T1 = 301 (styles.css global/topbar segment
// tokenized; remaining = canvas/inspector/mobile segments + 2 CanvasWorkspace
// TSX literals, all owned by T2–T4).
const BASELINE = 301;
