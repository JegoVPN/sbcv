...
const groups: PaletteGroup[] = [
  ...
  },
  {
    title: "Inbounds",
    items: [
      { label: "Direct", kind: "inbound-direct", icon: Cable, docsUrl: docs("inbound/direct/") },
      { label: "Mixed", kind: "mixed", icon: RadioTower, docsUrl: docs("inbound/mixed/"), ready: true },
      { label: "SOCKS", kind: "inbound-socks", icon: Network, docsUrl: docs("inbound/socks/") },
      { label: "HTTP", kind: "inbound-http", icon: Globe2, docsUrl: docs("inbound/http/") },
      { label: "Shadowsocks", kind: "inbound-shadowsocks", icon: Shield, docsUrl: docs("inbound/shadowsocks/") },
      { label: "VMess", kind: "inbound-vmess", icon: Shield, docsUrl: docs("inbound/vmess/") },
      { label: "Trojan", kind: "inbound-trojan", icon: Shield, docsUrl: docs("inbound/trojan/") },
      { label: "Naive", kind: "inbound-naive", icon: Globe2, docsUrl: docs("inbound/naive/") },
      { label: "Hysteria", kind: "inbound-hysteria", icon: Plug, docsUrl: docs("inbound/hysteria/") },
      { label: "ShadowTLS", kind: "inbound-shadowtls", icon: Shield, docsUrl: docs("inbound/shadowtls/") },
      { label: "VLESS", kind: "inbound-vless", icon: Shield, docsUrl: docs("inbound/vless/") },
      { label: "TUIC", kind: "inbound-tuic", icon: Plug, docsUrl: docs("inbound/tuic/") },
      { label: "Hysteria2", kind: "inbound-hysteria2", icon: Plug, docsUrl: docs("inbound/hysteria2/") },
      { label: "AnyTLS", kind: "inbound-anytls", icon: Shield, docsUrl: docs("inbound/anytls/") },
      { label: "TUN", kind: "tun", icon: RadioTower, docsUrl: docs("inbound/tun/"), ready: true },
      { label: "Redirect", kind: "inbound-redirect", icon: GitBranch, docsUrl: docs("inbound/redirect/") },
      { label: "TProxy", kind: "inbound-tproxy", icon: GitBranch, docsUrl: docs("inbound/tproxy/") },
      { label: "Cloudflared", kind: "inbound-cloudflared", icon: Globe2, docsUrl: docs("inbound/cloudflared/") },
    ],
  },
  {
    title: "Outbounds",
