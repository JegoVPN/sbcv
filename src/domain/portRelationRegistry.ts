...
export const portRelations: PortRelation[] = [
  ...
  relation("outbound-detour", "writable", endpoint("output", "outbound", "dial-detour", "Downstream dial detour", "spline", undefined, ["block", "selector", "urltest", "dns"]), endpoint("input", "outbound", "detour-target", "Upstream Dial detour target", "network", undefined, ["block", "dns"]), "/outbounds/*/detour", ["outbound"]),
  ...
  relation("endpoint-detour", "writable", endpoint("output", "endpoint", "dial-detour", "Dial detour outbound", "spline"), endpoint("input", "outbound", "detour-target", "Upstream Dial detour target", "network", undefined, ["block", "dns"]), "/endpoints/*/detour", ["outbound"]),
  relation("service-detour-ccm", "writable", endpoint("output", "service", "detour", "API detour outbound", "corner-down-right", "ccm"), endpoint("input", "outbound", "service-detour", "Upstream service detour target", "server"), "/services/*/detour", ["outbound"]),
  relation("service-detour-ocm", "writable", endpoint("output", "service", "detour", "API detour outbound", "corner-down-right", "ocm"), endpoint("input", "outbound", "service-detour", "Upstream service detour target", "server"), "/services/*/detour", ["outbound"]),
  relation("rule-set-download", "writable", endpoint("output", "rule-set", "download-detour", "Download detour", "download-cloud", "remote"), endpoint("input", "outbound", "rule-set-download", "Upstream Rule Set download detour", "layers"), "/route/rule_set/*/download_detour", ["outbound"]),
  relation("clash-api-download-detour", "writable", endpoint("output", "settings", "clash-download-detour", "Clash UI download detour", "download-cloud", "experimental"), endpoint("input", "outbound", "clash-download-detour", "Upstream Clash UI download detour target", "settings"), "/experimental/clash_api/external_ui_download_detour", ["outbound"]),
  ...
  relation("settings-ntp-detour", "writable", endpoint("output", "settings", "dial-detour", "NTP detour outbound", "spline", "ntp"), endpoint("input", "outbound", "detour-target", "Upstream Dial detour target", "network", undefined, ["block", "dns"]), "/ntp/detour", ["outbound"]),
];
