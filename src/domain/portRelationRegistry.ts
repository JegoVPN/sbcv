...
export const portRelations: PortRelation[] = [
  ...
  relation("route-rule-order", "order-only", endpoint("output", "route", "route-rule", "Route rule", "git-branch"), endpoint("input", "route-rule", "route", "Route order", "route")),
  ...
  relation("dns-rule-order", "order-only", endpoint("output", "dns", "dns-rule", "DNS rule", "git-branch"), endpoint("input", "dns-rule", "dns", "DNS order", "globe")),
  ...
  relation("dns-inbound-query", "decorative", endpoint("output", "inbound", "dns-rule-match", "DNS rule matcher", "git-branch"), endpoint("input", "dns", "inbound-query", "DNS query source", "radio")),
  ...
  relation("dns-server-detour", "writable", endpoint("output", "dns-server", "outbound", "Detour outbound", "network"), endpoint("input", "outbound", "dns-detour", "Upstream DNS detour target", "server"), "/dns/servers/*/detour", ["outbound"]),
