...
export const portRelations: PortRelation[] = [
  ...
  relation("service-ssm-inbound", "writable", endpoint("output", "inbound", "service", "SSM API service", "server", "shadowsocks"), endpoint("input", "service", "managed-inbound", "Managed Shadowsocks inbound", "radio", "ssm-api"), "/services/*/servers", ["inbound", "service"]),
  ...
  relation("settings-ntp-detour", "writable", endpoint("output", "settings", "dial-detour", "NTP detour outbound", "network", "ntp"), endpoint("input", "outbound", "detour-target", "Upstream Dial detour target", "network", undefined, ["block", "dns"]), "/ntp/detour", ["outbound"]),
];
