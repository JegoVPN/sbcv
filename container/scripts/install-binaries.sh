...
SB_TESTING_VERSION="${SB_TESTING_VERSION:-1.14.0-alpha.29}"
...
expected_sha256() {
  case "$1-${TARGETOS}-${TARGETARCH}" in
    ...
    1.14.0-alpha.29-linux-amd64) echo "610be90f18ab792cafe6557ea07fe3a4b4d1a77625aca0e22b283443d6d0749e" ;;
    *) echo "" ;;
  esac
}
