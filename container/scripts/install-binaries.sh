...
SB_TESTING_VERSION="${SB_TESTING_VERSION:-1.14.0-alpha.40}"
...
expected_sha256() {
  case "$1-${TARGETOS}-${TARGETARCH}" in
    ...
    1.14.0-alpha.40-linux-amd64) echo "dc44780a1e0afff257f866f330d08c66615772000ade73eae35832ac59db1a37" ;;
    *) echo "" ;;
  esac
}
